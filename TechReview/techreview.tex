...
\item Spell checking function included
\item Survey preview provided for both desktop and mobile devices
...
\subsubsection{Choice}
Google Forms was originally selected as the survey platform to be utilized, however, Qualtrics was not included in the initial technology review.
...
\begin{itemize}
\item Only works with Qualtric surveys, meaning data outside of Qualtrics can not be imported to be analyzed
\end{itemize}
...
\begin{itemize}
\item Needs to be free to use
\item Needs to read .csv data files (exclusions apply to Qualtrics if Qualtrics is the selected survey platform)
...
Qualtrics & No & Yes (Moderately detailed) & No \\ \hline 
\end{tabular}
\newline
...
Google Sheets, Microsoft Excel, and D3.js supports .csv file importing.
