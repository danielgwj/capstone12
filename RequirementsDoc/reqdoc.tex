...
\section{Gantt Chart}
\vfill
\begin{ganttchart}[hgrid, vgrid={*2{draw=none}, dotted}]{1}{27}
\gantttitle{2016}{9} 
\gantttitle{2017}{18} \\
...
\ganttbar{Identify render loop}{16}{18} \\ % 1 month
\ganttbar{Switch to 2-pass rendering}{19}{20} \\ % 0.67 month
\ganttbar{Implement shadows in simulation}{21}{23} \\ % 1 month
\ganttmilestone{Shadows Implementation Milestone}{23} \\
\ganttbar{Aesthetic evaluation}{24}{27} \\
\ganttbar{Conduct user interviews for performance metrics}{24}{25} \\ % 0.67 month
\ganttbar{Finalize and prepare for expo}{26}{27} \\
